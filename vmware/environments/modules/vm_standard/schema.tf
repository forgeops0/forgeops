resource "vsphere_virtual_machine" "vm-standard" {
  ...
  datastore_id              = var.vm_settings["vsphere_datastore_id"]
  ...
  clone {
    template_uuid = "421617d7-397c-b490-af39-16fa1b2881fb" #lookup(each.value, "vm_template", var.vm_settings["default_vm_template_uuid"])
